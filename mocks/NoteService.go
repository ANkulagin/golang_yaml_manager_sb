...
// UpdateTags provides a mock function with given fields: note, newTags
func (_m *NoteService) UpdateTags(note *entity.Note, newTags []string) error {
	ret := _m.Called(note, newTags)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*entity.Note, []string) error); ok {
		r0 = rf(note, newTags)
	} else {
		r0 = ret.Error(0)
	}
